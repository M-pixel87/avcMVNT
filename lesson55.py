...
net=jetson.inference.imageNet('alexnet',['--model=/home/uafs/Downloads/jetson-inference/python/training/detection/ssd/models/test_six','--input_blob=input_0','--output_blob=output_0','--labels=/home/uafs/Downloads/jetson-inference/python/training/detection/ssd/models/test_six/labels.txt'])

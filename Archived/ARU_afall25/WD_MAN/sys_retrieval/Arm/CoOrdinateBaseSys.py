...
# In CoOrdinateBaseSys.py

# REPLACE THE ORIGINAL CONNECTION LINE WITH THIS:
try:
    roarm = roarm(roarm_type="roarm_m3", port="/dev/ttyUSB0", baudrate=115200)
    print("✅ Arm Connected")
except Exception as e:
    print("⚠️ Arm hardware missing. Using Mock Arm.")
    
    # Create a fake class that does nothing but prevents crashes
    class MockArm:
        def joints_angle_ctrl(self, *args, **kwargs):
            pass # Do nothing
    roarm = MockArm()
